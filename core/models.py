...
class Contact(models.Model):
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="contacts", default=True
    )
...
class Trip(models.Model):
    ...
    subscribers = models.ManyToManyField(
        Contact, related_name="trip_subscribers", blank=True
    )
...
class Log(models.Model):
    ...
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="logs", default=True
    )
    ...
    def save(self, *args, **kwargs):
        geocoder_results = geocoder.mapbox(self.location, key=mapbox_token)
        geocode = geocoder_results.latlng
        if geocode:
            self.latitude, self.longitude = geocode
...
class Comment(models.Model):
    ...
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="user_comments", default=True
    )
