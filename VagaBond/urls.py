...
urlpatterns = [
    ...
    path('api/user/subscribed/', api_views.UserSubView.as_view(), name='subscribed'),
    path('api/user/current/subscribed/', api_views.UserCurrentSubView.as_view(), name='current-subscribed'),
